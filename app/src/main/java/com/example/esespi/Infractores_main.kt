    ...
    private fun Actualizar() {
        ...
        if (conn != null) {
            try {
                ...
                val query = "SELECT * FROM dbo.Infractores_Visualizar();"
                ...
                while (resultSet.next()) {
                    try {
                        ...
                        val cardView = layoutInflater.inflate(R.layout.infractores_card_infractor, null)

                        val lblNombre = cardView.findViewById<TextView>(R.id.Infractores_card_infractor_lblNombre)
                        val lblDui = cardView.findViewById<TextView>(R.id.Infractores_card_infractor_lblDui)
                        val imgInfractor = cardView.findViewById<ImageView>(R.id.Infractores_card_infractor_imgInfractor)
                        val btnInfo = cardView.findViewById<LinearLayout>(R.id.Infractores_card_infractor_info)
